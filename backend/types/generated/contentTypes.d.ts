...
export interface ApiAssetAsset extends Schema.CollectionType {
  ...
  attributes: {
    ...
    manufactureSerialNo: Attribute.String;
    location: Attribute.Relation<
      'api::asset.asset',
      'manyToOne',
      'api::location.location'
    >;
    asset_classification: Attribute.Relation<
      'api::asset.asset',
      'manyToOne',
      'api::asset-classification.asset-classification'
    >;
    depreciable: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    trackable: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    state: Attribute.Enumeration<['New', 'Used', 'Destructed']> &
      Attribute.Required &
      Attribute.DefaultTo<'New'>;
    type: Attribute.Enumeration<['Tools', 'Consumable']> & Attribute.Required;
    unit: Attribute.Enumeration<['Box', 'Unit', 'Container']> &
      Attribute.Required &
...
export interface ApiAssetClassificationAssetClassification
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    asset_classification: Attribute.Relation<
      ...
      'api::asset-classification.asset-classification'
    >;
    asset_classifications: Attribute.Relation<
      'api::asset-classification.asset-classification',
      'oneToMany',
      'api::asset-classification.asset-classification'
    >;
...
export interface ApiDepartmentDepartment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    code: Attribute.BigInteger & Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::asset-classification.asset-classification': ApiAssetClassificationAssetClassification;
